...
public static class RuntimeProfileResolver
{
    ...
    {
        if (managedInstall is null)
        {
            throw new InvalidOperationException(
                "The AetherXIV compatibility runtime is unavailable. Reinstall or repair this AetherXIV build; another Wine provider will not be selected automatically.");
        }
